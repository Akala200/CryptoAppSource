...
Future<dynamic> getMarketBTC() async {
  var res;
  var url = "https://cryptonew-apis.herokuapp.com/api/coin/market/btc"; // iOS
  res = await http.get(
      url,
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
...
Future<dynamic> getMarketUSDT() async {
  var res;
  var url = "https://cryptonew-apis.herokuapp.com/api/coin/market/sudt"; // iOS
  res = await http.get(
      url,
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
...
Future<dynamic> getMarketXPR() async {
  var res;
  var url = "https://cryptonew-apis.herokuapp.com/api/coin/market/xrp"; // iOS
  res = await http.get(
      url,
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
...
Future<dynamic> getMarketETH() async {
  var res;
  var url = "https://cryptonew-apis.herokuapp.com/api/coin/market/eth"; // iOS
  res = await http.get(
      url,
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
...
Future<dynamic> getBalance() async {
  ...
  print(email);
  var res;
  var url = "https://cryptonew-apis.herokuapp.com/api/balance/coin?email=$email"; // iOS
  res = await http.get(
      url,
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
...
Future<dynamic> getAllBalance() async {
  ...
  var email = prefs.getString('email');
  var res;
  var url = "https://cryptonew-apis.herokuapp.com/api/wallet/all?email=$email";
  res = await http.get(
      url,
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
...
Future<dynamic> getAllBalanceNaira() async {
  ...
  var email = prefs.getString('email');
  var res;
  var url = "https://cryptonew-apis.herokuapp.com/api/balance/naira?email=$email";
  res = await http.get(
      url,
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
