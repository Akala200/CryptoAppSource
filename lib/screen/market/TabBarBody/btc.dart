...
@override
List<btcMarket> getNew() {
  List<btcMarket> _listProducts = List<btcMarket>();
  getMarketBTC().then((value) {
    print(value);
    for(var u in value){
      _listProducts.add(btcMarket(name: u["currency"].toString(), priceValue: u["priceChange"].toString(), pairValue: u["price"].toString(), percent: u["percentage_change"].toString()));
    }
    btcMarketList = _listProducts;

    return btcMarketList == null ? [] : btcMarketList;
  });
}
