...
class verifyemailLoggedIn extends StatefulWidget {
  ThemeBloc themeBloc;
  verifyemailLoggedIn({this.themeBloc});
  @override
  _verifyemailLoggedIn createState() => _verifyemailLoggedIn(themeBloc);
}

class _verifyemailLoggedIn extends State<verifyemailLoggedIn> {
  ThemeBloc _themeBloc;
  _verifyemailLoggedIn(this._themeBloc);
  var code;
  @override
                        ...
                        child: Center(
                          child: RaisedButton(
                            onPressed: () async {
                              ...
                              var ressp = await verifyEmailCode(code);
                              if (ressp == 200){
                                Loader.hide();
